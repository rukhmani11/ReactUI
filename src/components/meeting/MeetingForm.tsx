...
const MeetingForm = () => {
  ...
  const { id, companyId, ReportingToUserId }: any = useParams();
      ...
      if (response) {
        ...
        if (result.isSuccess) {
          setValues((prevState: any) => ({
            ...
            VisitedClientBusinessUnitId: result.data.ClientBusinessUnitId || "",
          }));
  ...
  const getCompanyUser = () => {
    debugger
   values.ReportingToUserId= auth.Id,
     MeetingService.getSelectListUser(values.ReportingToUserId).then((response: any) => {
       setCompanyUser(response.data);
     });
   };
  ...
  const refreshClientEmployees = () => {
    debugger
    getSelectClientEmployeeByclientId(values.ClientId);
  };
  ...
  return (
    <div>
      <Title>{mode} Schedule Meeting </Title>
      <>
              ...
              <React.Fragment>
                ...
                <Grid item xs={12} sm={4}>
                    <Controls.Select
                      required
                      name="CompanyUserId"
                      label="Responsible Co. User*"
                      options={companyUsers}
                      value={
                        companyUsers.length > 0 ? values.CompanyUserId : ""
                      }
                  ...
                  <Grid item xs={12} sm={4}>
                    <Controls.Select
                      ...
                      label="Client Employee to Meet*"
                      options={clientEmployee}
                      value={
                        clientEmployee.length > 0 ? values.ClientEmployeeId : ""
                      }
                      onChange={(e: any) => {
                        OnChangeClientEmployee(e.target.value);
                        handleInputChange(e);
                      }}
                      error={errors.ClientEmployeeId}
                    />
                  </Grid>
               ...
               <Box marginLeft={3} height={320} width={400} marginTop={1} border={0.5} padding={2} alignItems={"center"}>
                  ...
                  <Grid item xs={12} sm={15}  marginBottom={2} >
                    <Controls.MultiSelect
                      ...
                      //value={ mode !== "Edit" ? values.MeetingClientAttendeesIds : selectedClientEmployees }
                      ...
                      // style={{ height: '300px' }}
                    />
                    <InputLabel>Select Other Client Employee </InputLabel>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={15}>
                    <Controls.MultiSelect
                      ...
                      labelledBy="Select Company User"
                      error={errors.MeetingCompanyAttendeesIds}
                    />
                    <InputLabel>Select Company Users </InputLabel>
                  </Grid>
               </Box>
